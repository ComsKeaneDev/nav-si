...
// import '../../core/services/audio/microphone_source.dart';
...
//           if (getSetting(DetectionSetting.search) && microphoneSource!.state != MicrophoneState.activeListening) {
...
//     await speaker.speak("Task: object detection.");
//
//     // if sending data: automatically search for all objects
//     if (sendData) {
//       await updateTargetObjects([...objectList]);
//       await updateSetting(DetectionSetting.search, true);
//     }
//   }
//
...
//         await updateSetting(DetectionSetting.search, true);
//       } else {
//         await speaker.speak("Failed to update search.", noLongerListening: true);
//       }
//     }
//   }
//
...
//       await speaker.speak('Searching for all objects', noLongerListening: true);
//     }
//     else {
...
//         }
//       }
//       await speaker.speak('Searching for: $spokenObjectList', noLongerListening: true);
//     }
//   }
//
...
//           await speaker.speak("Error: failed to send data.");
//         }
//       }
//
...
//         var objectPosition = (getSetting(DetectionSetting.position))? "near ${calculatePosition(
...
//         var objectColor = "";
//         if (!noColorDescription.contains(object) && getSetting(DetectionSetting.color)) {
...
//             await speaker.speak('Found: $objectColor $object $objectPosition');
//           }
//         } else {
...
//                     ElevatedButton(
//                       onPressed: () async {
//                         await switchToTask(DetectionTask.text, context);
//                       },
